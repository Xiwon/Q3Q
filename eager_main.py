"""
Q3Q :: Qwen3.5 MoE Text-Only Inference (Eager)
...
class QMoeEngine(nn.Module):
    ...
    def generate(
        ...
        for _ in range(max_new_tokens):
            ...
            if eos_set and next_token.item() in eos_set:
                break
        return input_ids
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Q3Q :: Qwen3.5 MoE eager inference")
